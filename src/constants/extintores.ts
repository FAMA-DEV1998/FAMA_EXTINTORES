export const MARCAS = ["Nacional", "Importado", "Nacional Splinker", "Importado Splinker", "Amerex", "Ansul", "Buckeye", "Badger"];

export const AGENTES = ["PQS", "CO2/BC", "AFFF", "Agua", "Halotron", "Clase K"];
