  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-red-500/30"
      ...
      <main className="max-w-400 mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        {extintorModal && (
          <ExtintorModal form={extintorForm} setForm={setExtintorForm} isEditing={editingRowIndex !== null} onClose={() => setExtintorModal(false)} onSave={saveExtintor} saving={saving} />
        )}
